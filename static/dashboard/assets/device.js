...
import { LivePlayer, MAX_SOCKET_FAILURES, chooseMode, hasWebCodecs, liveVideoAvailable, orientedScreen, } from './live.js';
...
const elements = {
    ...
    screenView: element('#screen-view'),
    screenCanvas: element('#screen-canvas'),
