...
const PATHS: Record<string, string> = {
    ...
    bolt: '<path d="M9 1.5L3.5 9H7.5l-.5 5.5L12.5 7H8.5z"/>',
    box: '<path d="M8 1.8l5.5 3v6.4L8 14.2 2.5 11.2V4.8z"/><path d="M2.5 4.8L8 7.9l5.5-3.1M8 7.9v6.3"/>',
    layers: '<path d="M8 1.8l6 3.1-6 3.1-6-3.1z"/><path d="M2 8.5l6 3.1 6-3.1"/>',
    link: '<path d="M6.5 9.5a2.6 2.6 0 0 0 3.7 0l2-2a2.6 2.6 0 0 0-3.7-3.7l-.9.9"/><path d="M9.5 6.5a2.6 2.6 0 0 0-3.7 0l-2 2a2.6 2.6 0 0 0 3.7 3.7l.9-.9"/>',
